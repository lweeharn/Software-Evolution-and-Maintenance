<%@ Page Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="CompareMaster.aspx.cs" Inherits="Assignment.CompareMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
         ...
         <div>
            <h1>Master Degree Programmes</h1>
            <label>
            ...
            &nbsp;<asp:DropDownList ID="ddlProgram1" runat="server" CssClass="dropdown">
                <asp:ListItem Text="Master of Computer Science" Value="Master of Computer Science" />
                <asp:ListItem Text="Master of Information Technology" Value="Master of Information Technology" />
                <asp:ListItem Text="Master of Science in Mathematical Sciences" Value="Master of Science in Mathematical Sciences" />
            </asp:DropDownList>

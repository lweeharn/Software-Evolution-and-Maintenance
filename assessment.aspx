<%@ Page Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="assessment.aspx.cs" Inherits="Assignment.assessment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <section id="result" class="text-center" style="padding:5% 15%;background-color:white">
    ...
    <div class="result-rows">
      <div class="row">
        <div class="col-lg-4 row-title">Interested Programme</div>
        <div class="col-lg-5" id="resultProgramme"></div>
      </div>

      <div class="row">
        <div class="col-lg-4 row-title">Assessment result</div>
        <div class="col-lg-5" id="resultAssessment"></div>
      </div>

      <div class="row">
        <div class="col-lg-4 row-title">Reason</div>
        <div class="col-lg-5" id="resultReason"></div>
      </div>
    </div>


          <a href="enrollment.aspx" class="btn btn-block btn-primary btn-lg">Enroll</a>
